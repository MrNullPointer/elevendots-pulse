    ...
    <ScrollReveal as="section" className="mb-8">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-medium section-title-gradient" style={{ fontSize: '15px' }}>
            {meta.display_name}
          </h2>
          <span className="hidden sm:inline" style={{ fontSize: '12px', color: 'var(--text-tertiary)' }}>
            {meta.description}
          </span>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 stagger-cards">

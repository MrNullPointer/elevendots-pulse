...
# Patterns are imported from crawler.content_safety — the SAME module the
# crawler admission gate uses to quarantine unsafe articles before they are
# written. Importing (rather than re-declaring) guarantees the admission gate
# and this re-validation gate can never drift apart.
from crawler.content_safety import (
